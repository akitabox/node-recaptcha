...
describe('recaptcha:', function () {
    ...
    describe('verify()', function () {
        describe('with correct data', function () {
            it('should verify with success equals true', function (done) {
                data = {
                    remoteip:  '127.0.0.1',
                    challenge: 'challenge',
                    response:  'good_response'
        ...
        describe('with incorrect data', function () {
            it('should fail verification with incorrect-captcha-sol error', function (done) {
                data = {
                    remoteip:  '127.0.0.1',
                    challenge: 'challenge',
        ...
        describe('with missing data.challenge', function () {
            it('should return with verify-params-incorrect error', function (done) {
                data = {
                    remoteip : '127.0.0.1',
                    response : 'response'
                };
