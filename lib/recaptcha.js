...
const VERIFY_END_POINT     = '/recaptcha/api/siteverify';
const SCRIPT_SRC_END_POINT = '/recaptcha/api.js';
const VERIFY_URL           = PROTOCOL + '://' + API_HOST + VERIFY_END_POINT;
const SCRIPT_SRC_URL       = PROTOCOL + '://' + API_HOST + SCRIPT_SRC_END_POINT;
